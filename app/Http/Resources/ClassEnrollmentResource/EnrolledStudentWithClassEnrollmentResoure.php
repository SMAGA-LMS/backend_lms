...
// ini awalnya buat urusan student enrollment with class enrollment
class EnrolledStudentWithClassEnrollmentResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        // $student_enrollment = $this->student_enrollment_id ? (object)[
        //     'id' => $this->student_enrollment_id,
        //     'classroom_id' => $this->student_enrollment_classroom_id,
        //     'user_id' => $this->student_enrollment_user_id,
        //     'status' => $this->student_enrollment_status,
        // ] : null;
        ...
        $dataResponse = [
            ...
            'studentEnrollment' => $this->student_enrollment_id,
